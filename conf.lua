...
EnemyStartingPoints  = { {1, 1}, {196, 1}, {386, 1} } 
LevelStartTime = 2.0
SlipTime = 0.38
EnemyReadyTime = 0.5
ScoreShowTime = 3.0
...
SCREEN_WIDTH = WindowSize.w
SCREEN_HEIGHT = WindowSize.h

function love.conf(t)
    t.identity = "love-battle-city"      -- The name of the save directory (string)
    ...
    t.window.title = "LÖVE Battle City"   -- The window title (string)
    t.window.icon = "assets/sprite/icon.png" -- Filepath to an image to use as the window's icon (string)
